--[[
    ...
    Changelog v0.4 -> v0.5:
    - [CORREGIDO] Error crítico "attempt to call missing method 'CreateSplash'". La UI ahora se inicializa correctamente.
    - [AÑADIDO] Opción para cambiar el color del indicador de texto "TARGET" del Aimbot.
    - [MEJORADO] Reestructurada la secuencia de carga de la UI para mayor estabilidad.
]]
...
-- Primero, se crea la ventana principal
local Window = Rayfield:CreateWindow({
    Name = "AVORN BETA v0.5",
    LoadingTitle = "AVORN BETA",
    LoadingSubtitle = "por yordy alias the strongest",
    ConfigurationSaving = { Enabled = true, FolderName = "AVORN_BETA", FileName = "Config_v5" },
})

-- [CORREGIDO v0.5] La pantalla de bienvenida se llama DESDE la ventana creada
Window:CreateSplash({
    Name = "AVORN BETA", SubName = "v0.5 - Cargando...", Color = Color3.fromRGB(255, 49, 49),
...
Console:Log("Sistema AVORN v0.5 inicializado.")
...
-- Las funciones GetClosestPlayerInFOV, CleanUpPlayerESP y AnimateFOVCircle no cambian
    ...
    if Aimbot.CurrentTarget and Aimbot.CurrentTarget.Character then
        ...
        if targetHead then
            ...
            if onScreen then
                ...
                TargetLabel.Color = Aimbot.TargetLabelColor -- [NUEVO v0.5] Color personalizable
...
Console:Log("Manejadores de eventos conectados.")
...
-- [NUEVO v0.5] Color del indicador de objetivo
CombatTab:CreateColorpicker({ Name = "Color del Indicador 'TARGET'", Default = Aimbot.TargetLabelColor, Flag = "TargetLabelColor", Callback = function(c) Aimbot.TargetLabelColor = c end })
